...
conf = fireeye.detection.Configuration(
    ...
    def __init__(self, host="https://feapi.marketplace.apps.fireeye.com",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("fireeye.detection")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'feye-auth-key' in self.api_key:
            auth['FireEyeAPIKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'feye-auth-key',
                'value': self.get_api_key_with_prefix('feye-auth-key')
            }
        return auth
