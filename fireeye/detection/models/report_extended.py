...
class ReportExtended(object):
    ...
    def engine_results(self, engine_results):
        ...
        """
        if self.local_vars_configuration.client_side_validation and engine_results is None:  # noqa: E501
            raise ValueError("Invalid value for `engine_results`, must not be `None`")  # noqa: E501
