...
from feye_detection.api.presigned_url_api import PresignedUrlApi  # noqa: E501
from feye_detection.rest import ApiException


class TestPresignedUrlApi(unittest.TestCase):
    """PresignedUrlApi unit test stubs"""

    def setUp(self):
        self.api = feye_detection.api.presigned_url_api.PresignedUrlApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_get_presigned_url(self):
        """Test case for get_presigned_url
